...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/crowdsourcephoto-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14253&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/crowdsourcephoto-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `crowdsourcephoto` can be installed with:

```
conda install crowdsourcephoto
```

It is possible to list all of the versions of `crowdsourcephoto` available on your platform with:
